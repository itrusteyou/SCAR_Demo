...
__C.DATASET = 'UCF50' # dataset selection: GCC, SHHA, SHHB, UCF50, QNRF, WE, Mall, UCSD
...
__C.NET = 'SCAR' # net selection: MCNN, AlexNet, VGG, VGG_DECODER, Res50, CSRNet, SANet , SCAR
